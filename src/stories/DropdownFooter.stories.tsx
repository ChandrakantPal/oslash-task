...
const Template: Story<React.PropsWithChildren> = (args) => (
  <DropdownFooter {...args} />
);

export const DefaultBlankDropdownFooter = Template.bind({});
DefaultBlankDropdownFooter.args = {};
export const DropdownFooterWithOneElement = Template.bind({});
DropdownFooterWithOneElement.args = {
  children: (
...
export const DropdownFooterWithMultipleElements = Template.bind({});
DropdownFooterWithMultipleElements.args = {
  children: (
    <>
      ...
      <FlexRowContainer justify="flex-end">
        <div style={{ marginRight: 10 }}>
          <svg
            width="14"
            height="14"
